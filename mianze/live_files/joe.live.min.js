    ...
    function a() {
        function a() {
            $.ajax({
                ...
                success(a) {
                    const e = a[n.index];
                    $(".joe_live__type-title .text").html(e.name);
                    let t = '<li class="item animated swing" data-gameId="">全部</li>';
                    e.list.forEach(a => t += `<li class="item animated swing" data-gameId="${a.gameId}">${a.name}</li>`), $(".joe_live__type-list").html(t), $(".joe_live__type-list .item").first().click()
                }
            })
        }
        ...
        function e() {
            window.scrollTo({
                top: 0,
                behavior: "smooth"
            }), n.isLoading = !0, $(".joe_live__list").html(""), $.ajax({
                url: Joe.BASE_API,
                type: "POST",
                dataType: "json",
                data: {
                ...
                success(a) {
                    ...
                    }), $(".joe_live__list").html(e), n.totalPage = a.data.totalPage, t()
                },
        ...
        $(".joe_live__type-title .icon").on("click", function() {
            ...
            n.isLoading || ($(this).addClass("active").siblings().removeClass("active"), n.page = 1, n.gameId = $(this).attr("data-gameId"), e())
        }), a(), $(".joe_live__pagination").on("click", ".joe_live__pagination-item", function() {
            const a = $(this).attr("data-page");
            a && !n.isLoading && (n.page = Number(a), e())
        })
    }
