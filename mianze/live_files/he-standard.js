! function(t) {
    ...
    NHnr: function(t, e, n) {
        ...
        J.prototype.parsePath = function(t) {
            ...
            return e || (e = function(t) {
                ...
                function d() {
                    var e = t[c + 1];
                    if (u === q && "'" === e || u === B && '"' === e) return c++, r = "\\" + e, p[I](), !0
                }
                for (p[N] = function() {
                ...
                methods: {
                    ...
                    getWeatherData: function() {
                        ...
                        dt.a.get(this.CONFIG.DATA_DOMAIN + "?key=" + this.wd.pluginConfig.key + "&location=CN" + t.wd.cityId + "&lang=" + t.$i18n.locale).then(function(e) {
                            var n = e.data;
                            if (n && "ok" === n.status) {
                                if (n.now && (t.wd.current = {}, t.fahrenheit ? t.wd.current.tmp = 9 * n.now.tmp / 5 + 32 + "℉" : t.wd.current.tmp = n.now.tmp + "°", t.wd.current.code = n.now.cond_code, t.wd.current.txt = n.now.cond_txt), n.air_now_city && (t.wd.current.aqi = n.air_now_city.aqi, t.wd.current.aqiTxt = n.air_now_city.qlty.replace("污染", "").replace("汙染", "").replace(" polluted", "").replace(" pollution", ""), t.wd.current.aqiTxt.length > 10 && (t.wd.current.aqiTxt = t.wd.current.aqiTxt.substring(0, 5) + "...")), n.rain && (t.wd.current.rain = n.rain.txt), t.wd.forecast = [], n.daily_forecast && n.daily_forecast.length > 0)
                                    for (var r = n.daily_forecast.length > 7 ? 7 : n.daily_forecast.length, i = ((new Date).getHours(), 0); i < r; i++) {
                                        ...
                                        a.date = s.Format("MM/dd"), a.max = o.tmp_max, a.min = o.tmp_min, t.fahrenheit ? (a.max = a.max + "℉", a.min = a.min + "℉") : (a.max = a.max + "°", a.min = a.min + "°"), a.coded = o.cond_code_d, a.coden = o.cond_code_n, t.wd.forecast.push(a)
                                    }
                                if (n.alarm && n.alarm.length > 0 && !t.wd.pluginConfig.demo ? (t.wd.alarm = {}, t.wd.alarm.txt = n.alarm[0].type, t.wd.alarm.level = n.alarm[0].level) : t.wd.pluginConfig.demo && ("en" == t.$i18n.locale ? t.wd.alarm.txt = "Rainstorm" : t.wd.alarm.txt = "暴雨", t.wd.alarm.level = "Orange"), n.air_forecast && n.air_forecast && n.air_forecast.length > 0) {
                                    ...
                                    for (var c = 0; c < l; c++) {
                                        ...
                                        t.wd.forecast[c].aqi = u.aqi, t.wd.forecast[c].aqiTxt = u.qlty.replace("污染", "").replace("汙染", "").replace(" polluted", "").replace(" pollution", "")
                                    }
                                }
                            }
                        }).catch(function(t) {})
                    ...
                    p: function(t) {
                        for (var e = 0; e < this.pArr.length; e++)
                            if (this.pArr[e].zh === t || this.pArr[e].hk === t || this.pArr[e].en === t) {
                                this.cArr = this.pArr[e].children, "zh" === this.$i18n.locale ? this.c = this.pArr[e].children[0].zh : "hk" === this.$i18n.locale ? this.c = this.pArr[e].children[0].hk : this.c = this.pArr[e].children[0].en, this.aArr = this.cArr[0].children, this.a = this.aArr[0].id;
                                break
                            }
                    },
                    c: function(t) {
    ...
    kV13: function(t, e, n) {
        ...
        (function(t) {
            ...
            var ot = function() {
                    return void 0 === W && (W = !K && !Z && void 0 !== t && (t.process && "server" === t.process.env.VUE_ENV)), W
                },
            ...
            function je(t) {
                t._o = $e, t._n = h, t._s = d, t._l = ye, t._t = _e, t._q = E, t._i = D, t._m = xe, t._f = we, t._k = Ce, t._b = ke, t._v = _t, t._e = yt, t._u = Te, t._g = Oe, t._d = Fe, t._p = Me
            }
            ...
            function qe(t, e, n, l, c, u) {
                return (Array.isArray(n) || a(n)) && (c = l, l = n, n = void 0), o(u) && (c = He),
                    function(t, e, n, a, l) {
                        ...
                        if ("string" == typeof e) {
                            var f;
                            u = t.$vnode && t.$vnode.ns || z.getTagNamespace(e), c = z.isReservedTag(e) ? new gt(z.parsePlatformTagName(e), n, a, void 0, void 0, t) : n && n.pre || !i(f = Rt(t.$options, "components", e)) ? new gt(e, n, a, void 0, void 0, t) : Re(f, n, t, a, e)
                        } else c = Re(e, n, t, a);
            ...
            function Zn(t) {
                return Array.isArray(t) ? function(t) {
                    for (var e, n = "", r = 0, o = t.length; r < o; r++) i(e = Zn(t[r])) && "" !== e && (n && (n += " "), n += e);
                    return n
                }(t) : s(t) ? function(t) {
                    var e = "";
            ...
            function mr(t, e) {
                ...
                if (!(i(n) && !1 === n.Ctor.options.inheritAttrs || r(t.data.attrs) && r(e.data.attrs))) {
                    ...
                    for (o in (X || Q) && c.value !== l.value && yr(s, "value", c.value), l) r(c[o]) && (qn(o) ? s.removeAttributeNS(Hn, Bn(o)) : Nn(o) || s.removeAttribute(o))
                }
            }

            function yr(t, e, n) {
                t.tagName.indexOf("-") > -1 ? _r(t, e, n) : zn(e) ? Un(n) ? t.removeAttribute(e) : (n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : Nn(e) ? t.setAttribute(e, Pn(e, n)) : qn(e) ? Un(n) ? t.removeAttributeNS(Hn, Bn(e)) : t.setAttributeNS(Hn, e, n) : _r(t, e, n)
            }
            ...
            function br(t, e) {
                ...
                if (!(r(o.staticClass) && r(o.class) && (r(a) || r(a.staticClass) && r(a.class)))) {
                    ...
                    i(l) && (s = Kn(s, Zn(l))), s !== n._prevClass && (n.setAttribute("class", s), n._prevClass = s)
                }
            }
            ...
            function Pr(t, e, r, i, o, a, s, l) {
                var c;
                (i = i || n).right ? l ? e = "(" + e + ")==='click'?'contextmenu':(" + e + ")" : "click" === e && (e = "contextmenu", delete i.right) : i.middle && (l ? e = "(" + e + ")==='click'?'mouseup':(" + e + ")" : "click" === e && (e = "mouseup")), i.capture && (delete i.capture, e = Rr("!", e, l)), i.once && (delete i.once, e = Rr("~", e, l)), i.passive && (delete i.passive, e = Rr("&", e, l)), i.native ? (delete i.native, c = t.nativeEvents || (t.nativeEvents = {})) : c = t.events || (t.events = {});
                var u = Ur({
                    value: r.trim(),
                    dynamic: l
                }, s);
            ...
            var Ai = b(function(t) {
                ...
                ji = "animation",
                Li = "animationend";
            Si && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (Fi = "WebkitTransition", Mi = "webkitTransitionEnd"), void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && (ji = "WebkitAnimation", Li = "webkitAnimationEnd"));
            ...
            function zi(t, e) {
                var n, r = window.getComputedStyle(t),
                    ...
                    u = 0,
                    f = 0;
                return e === Oi ? a > 0 && (n = Oi, u = a, f = o.length) : e === Ti ? c > 0 && (n = Ti, u = c, f = l.length) : f = (n = (u = Math.max(a, c)) > 0 ? a > c ? Oi : Ti : null) ? n === Oi ? o.length : l.length : 0, {
                    type: n,
                    timeout: u,
                    propCount: f,
                    ...
                    if (!S || b || "" === b) {
                        ...
                        var N = !1 !== a && !Y,
                            ...
                            P = n._enterCb = I(function() {
                                N && (Ni(n, F), Ni(n, T)), P.cancelled ? (N && Ni(n, O), E && E(n)) : L && L(n), n._enterCb = null
                            });
                        t.data.show || le(t, "insert", function() {
                            ...
                            Ni(n, O), P.cancelled || (Ii(n, F), R || (Wi(D) ? setTimeout(P, D) : Ri(n, l, P)))
            ...
            function Ui(t, e) {
                ...
                function k() {
                    C.cancelled || (!t.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[t.key] = t), p && p(n), _ && (Ii(n, c), Ii(n, f), Di(function() {
                        Ni(n, c), C.cancelled || (Ii(n, u), w || (Wi(b) ? setTimeout(C, b) : Ri(n, l, C)))
                    })), d && d(n, C), _ || w || C())
                }
            }
            ...
            var Zi = function(t) {
                ...
                for (e = 0; e < sr.length; ++e)
                    for (s[sr[e]] = [], n = 0; n < l.length; ++n) i(l[n][sr[e]]) && s[sr[e]].push(l[n][sr[e]]);
            ...
            }, T(An.options.directives, io), T(An.options.components, mo), An.prototype.__patch__ = K ? Zi : M, An.prototype.$mount = function(t, e) {
            ...
            function ga(t, e) {
                ...
                }), Go = Lr(e.modules, "transformNode"), Jo = Lr(e.modules, "preTransformNode"), Xo = Lr(e.modules, "postTransformNode"), Zo = e.delimiters;
                var r, i, o = [],
                ...
                return function(t, e) {
                        ...
                        if (n = t, r && Po(r)) {
                            var c = 0,
                                ...
                                p = t.replace(f, function(t, n, r) {
                                    return c = r.length, Po(u) || "noscript" === u || (n = n.replace(/<!\--([\s\S]*?)-->/g, "$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g, "$1")), Wo(u, n) && (n = n.slice(1)), e.chars && e.chars(n), ""
                                });
                            ...
                            var w = void 0,
                                ...
                                C = void 0;
                            if (d >= 0) {
                                for (b = t.slice(d); !(Do.test(b) || Lo.test(b) || No.test(b) || Ro.test(b) || (C = b.indexOf("<", 1)) < 0);) d += C, b = t.slice(d);
                                w = t.substring(0, d)
                            }
                    ...
                    function x() {
                        ...
                        if (e) {
                            ...
                            for (k(e[0].length); !(n = t.match(Eo)) && (r = t.match(Fo) || t.match(To));) r.start = l, k(r[0].length), r.end = l, i.attrs.push(r);
                    ...
                    chars: function(t, e, n) {
                        if (i && (!X || "textarea" !== i.tag || i.attrsMap.placeholder !== t)) {
                            ...
                            if (t = c || t.trim() ? "script" === (r = i).tag || "style" === r.tag ? t : da(t) : f.length ? s ? "condense" === s && fa.test(t) ? "" : " " : a ? " " : "" : "") c || "condense" !== s || (t = t.replace(pa, " ")), !l && " " !== t && (o = bo(t, Zo)) ? u = {
                                type: 2,
                ...
                return function(t) {
                    ...
                    for (e = 0, n = c.length; e < n; e++) {
                        if (r = i = c[e].name, o = c[e].value, na.test(r))
                            if (t.hasBindings = !0, (a = ba(r.replace(na, ""))) && (r = r.replace(ca, "")), la.test(r)) r = r.replace(la, ""), o = Fr(o), (l = aa.test(r)) && (r = r.slice(1, -1)), a && (a.prop && !l && "innerHtml" === (r = k(r)) && (r = "innerHTML"), a.camel && !l && (r = k(r)), a.sync && (s = Vr(o, "$event"), l ? Pr(t, '"update:"+(' + r + ")", s, null, !1, 0, c[e], !0) : (Pr(t, "update:" + k(r), s, null, !1, 0, c[e]), A(r) !== k(r) && Pr(t, "update:" + A(r), s, null, !1, 0, c[e])))), a && a.prop || !t.component && Qo(t.tag, t.attrsMap.type, r) ? Er(t, r, o, c[e], l) : Dr(t, r, o, c[e], l);
                            else if (ea.test(r)) r = r.replace(ea, ""), (l = aa.test(r)) && (r = r.slice(1, -1)), Pr(t, r, o, a, !1, 0, c[e], l);
                        else {
                    ...
                    directives: {
                        model: function(t, e, n) {
                            ...
                            if ("select" === o) ! function(t, e, n) {
                                ...
                                Er(t, "checked", "Array.isArray(" + e + ")?_i(" + e + "," + i + ")>-1" + ("true" === o ? ":(" + e + ")" : ":_q(" + e + "," + o + ")")), Pr(t, "change", "var $$a=" + e + ",$$el=$event.target,$$c=$$el.checked?(" + o + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + i + ")" : i) + ",$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(" + Vr(e, "$$a.concat([$$v])") + ")}else{$$i>-1&&(" + Vr(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") + ")}}else{" + Vr(e, "$$c") + "}", null, !0)
                            }(t, r, i);
                            else if ("input" === o && "radio" === a) ! function(t, e, n) {
                                var r = n && n.number,
                                    i = Hr(t, "value") || "null";
                                Er(t, "checked", "_q(" + e + "," + (i = r ? "_n(" + i + ")" : i) + ")"), Pr(t, "change", Vr(e, i), null, !0)
                            }(t, r, i);
                                ...
                                var f = Vr(e, u);
                                l && (f = "if($event.target.composing)return;" + f), Er(t, "value", "(" + e + ")"), Pr(t, c, f, null, !0), (s || a) && Pr(t, "blur", "$forceUpdate()")
                            }(t, r, i);
            ...
            var Ha = {
                ...
                qa = function(t) {
                    this.options = t, this.warn = t.warn || jr, this.transforms = Lr(t.modules, "transformCode"), this.dataGenFns = Lr(t.modules, "genData"), this.directives = T(T({}, Ha), t.directives);
